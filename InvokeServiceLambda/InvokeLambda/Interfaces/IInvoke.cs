...
namespace InvokeLambda.Interfaces
{
    public interface IInvoke
    {
        ...
        Task<T> InvokeLambdaAsync<T>(string functionName, string payload, string invocationType = "RequestResponse", CancellationToken cancellationToken = default) where T : Response, new();
    }
}
