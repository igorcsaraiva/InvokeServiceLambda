...
namespace InvokeLambda.AmazonLambdaService
{
    public class Security : ISecurity
    {
        ...
        public Security()
        {
            amazonSecurityTokenService = new AmazonSecurityTokenServiceClient();
        }
        ...
        public async Task<Credentials> AssumeRoleAsync(string roleArn, string roleSessionName)
        {
            var result = await amazonSecurityTokenService.AssumeRoleAsync(new AssumeRoleRequest { RoleArn = roleArn, RoleSessionName = roleSessionName });
